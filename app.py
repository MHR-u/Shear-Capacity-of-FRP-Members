...
st.set_page_config(
    ...
    page_icon="https://github.com/MHR-u/Shear-Capacity-of-FRP-Members/blob/main/FRP_RC.png",
    layout="centered"
)
...
st.markdown(f"""
    <div class="title-container">
        ...
        <div class="image-container">
            <img src="https://github.com/MHR-u/Shear-Capacity-of-FRP-Members/blob/main/FRP_RC.png" alt="Image">
        </div>
    </div>
    <hr>
""", unsafe_allow_html=True)

...
def generate_pdf_report(b, d, a, fc, roh_l, fy, e, Vn):
    ...
    pdf.cell(200, 10, txt=f"ρᵧ (dimensionless): {roh_l}", ln=True)
...
- **ρᵧ (dimensionless)**: Reinforcement ratio, which is the ratio of the area of reinforcement to the area of concrete in the section.
...
roh_l = st.number_input("ρᵧ (dimensionless):", value=0.0, help="Reinforcement ratio (dimensionless).")
